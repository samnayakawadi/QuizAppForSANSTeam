...
import NewOption from "../../create-new-question/NewOption";

const UpdateModal = ({ loadAllQuestions, isModal, onClickHandler, data, questionData, setQuestionData }) => {
                ...
                <div className={`modal ${active}`}>
                    ...
                    <div className="modal-card">
                        <header className="modal-card-head">
                            <p className="modal-card-title">Update Question - {data.questiontitle}</p>
                            <button
